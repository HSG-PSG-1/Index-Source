...
namespace HSG.Helper
{
    ...
    {
        public const string baseNamespace = "HSG";
        ...
        public const string cookieName = "HSGcookie";
        public const string emailCookie = "HSGCookieEmail";
        public const string passwordCookie = "HSGCookiePWD";
     ...
     msgContainer?? "msg", msg , hide);
        ...
        /*public static string formatExceptionDetails(object err, ref string errDetails)
        {
            ...
            if ( _SessionUsr.ID > 0)//_SessionUsr != null &&
